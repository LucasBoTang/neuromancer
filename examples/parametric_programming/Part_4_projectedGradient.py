...
using projected gradient method in Neuromancer.
...
if __name__ == "__main__":
    ...
    """
    add differentiable optimization solver layer
    """
    ...
    # # TODO: to debug newton method
    # # instantiate newton method layer to correct the solutions from the neural net:
    # # newton(proj(sol_map(xi))) -> x
    # newton = solvers.IterativeSolver(constraints=[con_1],          # equality constraints to be corrected
    #                                  input_keys=["x"],             # primal variable to be updated
    #                                  num_steps=3,                  # number of rollout steps of the solver method
    #                                  step_size=0.1,                # step size of the solver method
    #                                  )
